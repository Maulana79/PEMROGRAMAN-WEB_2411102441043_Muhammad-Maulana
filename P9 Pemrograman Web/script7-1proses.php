...
echo "<p>Nilai maksimum dari " . $bilangan1 . ", " . $bilangan2 . ", dan " . $bilangan3 . " (Cara 1) adalah: " . $maxAkhir . "</p>";
...
echo "<p>Nilai maksimum dari " . $bilangan1 . ", " . $bilangan2 . ", dan " . $bilangan3 . " (Cara 2) adalah: " . $maxAkhir . "</p>";
...
echo "<p>Nilai maksimum dari " . $bilangan1 . ", " . $bilangan2 . ", dan " . $bilangan3 . " (Cara 3) adalah: " . $maxAkhir . "</p>";
